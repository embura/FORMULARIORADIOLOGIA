...
const Grid = ({ tomografia, radiografia, documentacao, protocolos, servicos }) => {
    return (
        <div className="parent">
            ...
            <div class="verde verde3 header">{<tomografia.Header/>}</div>

            <div class="azul1 azul titulo">{<radiografia.Titulo />}</div>
            <div class="azul2 azul">{<radiografia.Coluna />}</div>
            <div class="azul3 azul header">{<radiografia.Header />}</div>
            ...
            <div class="amarelo3 amarelo header">{<documentacao.Header />}</div>
            ...
            <div class="rosa4 rosa header">{<protocolos.Header/>}</div>
            ...
            <div class="roxo4 roxo header">{<servicos.Header/>}</div>
        </div>
