          ...
          <div>
            <ul>
              ...
              <li>
                ...
                <label for="altissima">
                  Investigativa Altíssima resolução (por elemento) assinale
                </label>
              </li>
              <li>
                <input type="checkbox" id="periodontal" />
                <label for="periodontal">
                  Estudo Cristas Ósseas e Gengival (periodontal)
                </label>
              </li>
              <li>
                <input type="checkbox" id="outra" />
          ...
          <div>
            <ul>
              ...
              <li>
                ...
                <label for="simplificada">
                  Simplificada (sagital em oclusão)
                </label>
              </li>
              <li>
                <input type="checkbox" id="outra" />
